...
import { LogOut, Bell, ShieldCheck, Key, Clock, School, UserCheck } from 'lucide-react';
...
export const Header: React.FC = () => {
  ...
  return (
    <header id="app-header" className="bg-white/90 backdrop-blur-md border-b border-indigo-100/80 sticky top-0 z-30 shadow-xs transition-all">
      <div className="h-1 w-full bg-gradient-to-r from-violet-600 via-indigo-600 to-pink-500"></div>
      <div className="px-4 lg:px-6 py-2.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        {/* Left Branding */}
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-violet-600 via-indigo-600 to-pink-500 flex items-center justify-center text-white shadow-md shadow-indigo-300/40 shrink-0 font-bold">
            {settings.schoolLogo ? (
