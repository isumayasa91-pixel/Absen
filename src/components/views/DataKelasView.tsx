...
import { School, FileSpreadsheet, Plus, Save, Users, CheckCircle2, Upload } from 'lucide-react';

export const DataKelasView: React.FC = () => {
  const { classes, addClass, importClasses, teachers, academicYears } = useApp();
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {classes.map((c) => (
          <div
            key={c.id}
            className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs hover:shadow-md transition-all space-y-3"
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-1 text-slate-500 text-xs font-bold">
                ...
                <span>{c.studentCount || 30} Siswa</span>
              </div>
            </div>
